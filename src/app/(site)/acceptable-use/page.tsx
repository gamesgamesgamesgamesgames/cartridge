		...
		<div className={'mx-auto w-full max-w-4xl px-4 py-24'}>
			...
			<div
				...
				<p>
					...
					Cartridge.dev, LLC under any ongoing agreement. It’s designed to
					protect us, our customers and the general Internet community from
					unethical, irresponsible and illegal activity.
				</p>
				<p>
					Cartridge.dev, LLC customers found engaging in activities prohibited
					by this acceptable use policy can be liable for service suspension and
				...
				<h3>Unauthorized Use of Cartridge.dev, LLC Property</h3>
				<p>
					We prohibit the impersonation of Cartridge.dev, LLC, the
					representation of a significant business relationship with
					Cartridge.dev, LLC, or ownership of any Cartridge.dev, LLC property
