	...
	return (
		<div className={'mx-auto w-full max-w-4xl px-4 py-24'}>
			...
			<div
				...
				<p>
					Your privacy is important to us. It is Cartridge.dev, LLC's policy to
					...
					across our website,{' '}
					<a href='https://cartridge.dev'>https://cartridge.dev</a>, and other
				...
				<p>
					...
					content to us, when you register an account or when you contact us —
				...
				<p>
					...
					United States of America (the) or where we or our partners,
				...
				<p>
					...
					receiving communications from us, including marketing and promotional
					messages, at any time. To do so, use the opt-out facilities provided
					in the communication. For example, you can click the “unsubscribe”
					link included in any marketing email we send you, reply “STOP” to any
					SMS messages we send you, visit{' '}
					<a href='https://cartridge.dev'>https://cartridge.dev</a>, or contact
					us at directly using the contact information provided in this privacy
					policy. In certain cases, we may request additional information to
					verify your identity before processing your opt-out request.
				</p>
				<p>
					Please be aware that even if you opt out of communications, we may
					still contact you when necessary for non-promotional purposes,
					including, but not limited to, managing your account, responding to
					service inquiries, or providing important updates related to your use
					of our services.
				</p>
				...
				<p>
					...
					organizations (known as "data processors"). We, Cartridge.dev, LLC,
				...
				<p>
					...
					for us to provide, operate, improve and communicate our services. If
					you submit comments intended for publishing on our site, we may
					require some details about you in order to identify you as the content
					author. We consider our legitimate interests to include research and
					...
					marketing analysis, and measures taken to protect our legal rights and
					interests.
				</p>
				...
				<p>
					...
					financial information, information about your appearance, your views
					and opinion (such as those expressed online or through a survey),
					opinions held about you by others, and any personal correspondences
					you may have with us. While this information may not directly identify
					you, be aware that it may be combined with other information to do so.
				</p>
				<p>
					...
					Cartridge.dev, LLC, are intended as equivalent to one another in every
					way, shape and form.
				</p>
				<h3>Valid Consent</h3>
				<p>
					...
					can respond to your enquiry. Under PIPEDA, consent is only valid if it
					is reasonable to expect that an individual to whom the organization's
				...
				<p>
					While Cartridge.dev, LLC endeavors to keep, store and handle customer
					data within locations in Canada, it may use agents or service
					providers located in the United States (U.S.), European Economic Area
					(EEA) or United Kingdom (UK) to collect, use, retain and process
					personal information as part of providing services to you. While we
					use all reasonable efforts to ensure that personal information
					receives the same level of security in any other jurisdiction as it
					would in Canada, please be aware that privacy protections under U.S.
					laws may not be the same adequacy.
				</p>
				<h3>Customer Data Rights</h3>
				<p>
					Although PIPEDA does not contain an extensive set of consumer rights,
					it does grant consumers the right to:
				</p>
				<ul>
					<li>
				...
				<p>
					...
					subject to this law. Under PIPEDA, you need to make your access
					request in writing and pay a minimal fee of $30.00.
				</p>
				<p>
					If any organizational fees seem unjust, you have the right to complain
					about this. We retain the right to decide how we disclose the copies
					of your PII to you. We will take all necessary measures to fulfill
					your request in 30 days from receipt, otherwise we must inform you of
				...
				<p>
					...
					circumstances, we will advise you of the delay within the first 30
					days and explain the reason for it.
				</p>
				...
				<p>
					...
					Contact Us section of this privacy policy if you believe your PII on
					our systems is incorrect or incomplete.
				</p>
				<p>
					If we cannot agree on changing the information, you have the right to
					have your concerns recorded with the Office of the Privacy Commission
					of Canada.
				</p>
				...
				<ol type='1'>
					<li>
						<strong>Accountability.</strong> Cartridge.dev, LLC is responsible
						for the PII under its control and will designate one or more persons
						to ensure organizational accountability for compliance with the ten
					...
					<li>
						<strong>Identifying purposes.</strong> Cartridge.dev, LLC identifies
						the purposes for which personal information is collected at or
						before the time the information is collected.
					</li>
					<li>
						<strong>Consent.</strong> Consent is required for Cartridge.dev,
						LLC's collection, use or disclosure of personal information, except
						where required or permitted by PIPEDA or other law. In addition,
						when customers access a product or service offered by us, consent is
						...
						product or service following Cartridge.dev, LLC's notification of
						changes.
					</li>
					<li>
						<strong>Limiting collection.</strong> Personal information collected
						will be limited to that which is necessary for the purposes
						identified by Cartridge.dev, LLC.
					</li>
					<li>
						<strong>Limiting use, disclosure and retention.</strong> We will not
						use or disclose personal information for purposes other than those
						for which the information was collected, except with your consent or
						as required by law. We will retain personal information only for as
						long as is necessary to fulfill the purposes for collecting such
						information and compliance with any legal requirements.
					</li>
					<li>
						<strong>Accuracy.</strong> Personal information will be maintained
						by Cartridge.dev, LLC in an accurate, complete and up-to-date format
						as is necessary for the purpose(s) for which the personal
						information was collected.
					</li>
					<li>
						<strong>Safeguards.</strong> We will protect personal information
					...
					<li>
						...
						information and in most cases, will respond within 30 days of
						receipt of such requests. Customers may verify the accuracy and
					...
					<li>
						...
						direct any questions or inquiries concerning our compliance with
						this privacy policy and PIPEDA requirements using the contact
				...
				<p>
					To enquire about Cartridge.dev, LLC's privacy policy, or to report
					violations of user privacy, you may contact us using the details in
				...
				<p>
					...
					personal information that we hold about you at any time by submitting
					a Data Subject Access Request (DSAR). The statutory deadline for
					fulfilling a DSAR request is 30 calendar days from our receipt of your
					request.
				</p>
				<p>
					<strong>Right to Erasure:</strong> In certain circumstances, you can
					ask for your personal data to be erased from the records held by
				...
				<ul>
					...
					<li>
						...
						that consent has been withdrawn. Cartridge.dev, LLC relies on
				...
				<p>
					<strong>Right to Portability:</strong> Individuals have the right to
					get some of their personal data from an organisation in a way that is
				...
				<ul>
					<li>
						...
						Cartridge.dev, LLC in electronic form; and
					</li>
					<li>
				...
				<p>
					...
					inaccurate, out of date, or incomplete, individuals have the right to
					correct, update or complete that data. Collectively this is referred
					to as the right to rectification. Rectification may involve filling
					the gaps i.e. to have to have incomplete personal data completed -
					although this will depend on the purposes for the processing. This may
				...
				<p>
					<strong>Complaints:</strong> You have the right, at any time, to lodge
					a complaint with the Information Commissioner's Office (ICO), the UK
					...
					using the details below. Please provide us with as much information as
					you can about the alleged breach. We will promptly investigate your
				...
				<p>
					...
					SK9 5AF <br />
					<br />
					Tel: <a href={'tel:03031231113'}>0303 123 1113</a> (local rate)
					<br />
				...
				<p>
					...
					<br />
					<a href={'mailto:privacy@cartridge.dev'}>privacy@cartridge.dev</a>
				</p>
			</div>
		</div>
	)
