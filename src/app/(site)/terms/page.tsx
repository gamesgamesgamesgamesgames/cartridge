		...
		<div className={'mx-auto w-full max-w-4xl px-4 py-24'}>
			...
			<div
				...
				<p>
					...
					<a href='https://cartridge.dev'>https://cartridge.dev</a> and any
					related services provided by Cartridge.dev, LLC.
				</p>
				<p>
					By accessing <a href='https://cartridge.dev'>https://cartridge.dev</a>
					...
					using any other services provided by Cartridge.dev, LLC.
				</p>
				<p>
					We, Cartridge.dev, LLC, reserve the right to review and amend any of
				...
				<ul>
					...
					<li>
						...
						service Cartridge.dev, LLC provides;
					</li>
					<li>
				...
				<p>
					...
					are owned by or licensed to Cartridge.dev, LLC and are protected by
				...
				<p>
					...
					is' basis. To the extent permitted by law, Cartridge.dev, LLC makes no
				...
				<p>
					In no event shall Cartridge.dev, LLC or its suppliers be liable for
					...
					on this website, even if Cartridge.dev, LLC or an authorized
				...
				<p>
					...
					for general information purposes only. Cartridge.dev, LLC does not
				...
				<h2>Links</h2>
				<p>
					Cartridge.dev, LLC has not reviewed all of the sites linked to its
					website and is not responsible for the contents of any such linked
					site. The inclusion of any link does not imply endorsement, approval
					or control by Cartridge.dev, LLC of the site. Use of any such linked
				...
				<p>
					...
					with the laws of Madison, WI. You irrevocably submit to the exclusive
